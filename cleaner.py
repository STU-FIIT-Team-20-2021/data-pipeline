...
def main(input_file, output_file, correlation_threshold=0.95, outliers_threshold=4.2, preserve_columns=None,
         remove=False):
...
if __name__ == "__main__":
    ...
    main('data/merger_output/merged.csv', 'data/cleaner_output/cleaned.csv', **args)
